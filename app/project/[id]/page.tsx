...
import { FaPlay, FaUser, FaClock, FaCode } from 'react-icons/fa'
...
export default function ProjectDetailPage() {
  ...
  // loadComments function - COMMENTED OUT
  /*
  ...
  */
  ...
  // handleComment function - COMMENTED OUT
  /*
